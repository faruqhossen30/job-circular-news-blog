                    ...
                    <form action="{{route('news.update', $news->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="widget green">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i> Create News </h4>
                                <span class="tools">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="title" value="{{$news->title}}" type="text" class="span12 " placeholder="Title" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Description</label>
                                    <div class="controls">
                                        <textarea name="content" class="span12 ckeditor" rows="6">
                                            {{$news->content}}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="meta_content" class="span12" name="editor1" rows="6">
                                            {{$news->meta_content}}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">Meta Keyword:</label>
                                    <div class="controls">
                                        <input name="end_date" type="date" class="tags" value="" />
                                    </div>
                                </div>
